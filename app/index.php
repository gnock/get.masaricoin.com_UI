...
ist-item>-->
	 ...
	 <!-- <iframe src="https://discordapp.com/widget?id=411195170642460672&theme=dark" width="220" height="478" allowtransparency="true" frameborder="0"></iframe>
        ...
        <md-content flex id="main">
          <md-toolbar class="navbar md-whiteframe-2dp">
            <div class="md-toolbar-tools maintoolbar" layout="row" style="background-image:url(assets/header.fw.png)">
              ...
              <span id="NetworkPercent" class="flex text-center wrap" style="color:#AFD5AF;">Network Percent: <b class="nowrap">{{(((poolStats.global.hashRate) / (network.difficulty | difficultyToHashRate)) * 100).toFixed(2)}}%</b>
              ...
              <span id="RemUserPerc" class="flex text-center wrap" style="color:#7FDBFF; display:none;">Pool Percent: <b class="nowrap">{{((((yourTotalHashRate) / (poolStats.global.hashRate)) * 100) || '0').toFixed(2)}}%</b>
      ...
      <script src="user/dashboard/blockpayments.js"></script>
